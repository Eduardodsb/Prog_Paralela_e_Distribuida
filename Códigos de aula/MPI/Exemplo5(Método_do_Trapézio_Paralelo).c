...
* 2. Cada processo diferente de 0 envia sua integral parcial para o processo 0.
* 3. O processo 0 soma os valores recebidos dos processos
...
int main(int argc, char  *argv[]) { 
    ...
    int num_procs;           /* O número de processos        */
    ...
    double integral = 0.0;   /* Integral de cada processo    */
