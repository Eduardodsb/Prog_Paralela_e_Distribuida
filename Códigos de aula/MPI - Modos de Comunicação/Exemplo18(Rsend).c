/*
Modo de comunicação: Pronto

No modo pronto é necessário que que um rotina de recepção seja iniciada antes de uma rotina de envio.
Tal modo costuma ter um desempenho melhor que o modo padrão, porém isso não é garantido.
*/
